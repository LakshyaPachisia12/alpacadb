    ...
    def _evaluate_condition(self, row, col_names, condition):
        ...
        if isinstance(condition, BinaryOp):
            ...
            if op == '=':
                ...
                return (self._evaluate_condition(row, col_names, condition.left) and
                        self._evaluate_condition(row, col_names, condition.right))
            elif op == 'OR':
                return (self._evaluate_condition(row, col_names, condition.left) or
                        self._evaluate_condition(row, col_names, condition.right))
